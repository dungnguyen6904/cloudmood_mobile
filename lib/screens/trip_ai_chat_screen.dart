      ...
      children: [
        ...
        GestureDetector(
          onVerticalDragStart: (details) {
            setState(() {
              ...
              _dragHeight = _isFullScreen ? (screenHeight - headerHeight) : 45.0;
            });
          },
        ...
        Expanded(
          ...
          child: Row(
            ...
            children: [
              const Icon(Icons.info_rounded, color: AppTheme.subtitleText, size: 20),
              ...
              if (_isFullScreen)
                Positioned(
                  ...
                  child: FloatingActionButton(
                    ...
                    backgroundColor: const Color(0xFF1E293B), // Dark color
                    elevation: 4,
                      ...
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          decoration: const BoxDecoration(
                            color: Color(0xFFA5B4FC), // Light indigo for the button
            ...
            child: Column(
              children: [
                ...
                CircleAvatar(
                  backgroundColor: Colors.white,
                  child: IconButton(
                    icon: const Icon(Icons.layers_outlined, color: AppTheme.darkText),
                    onPressed: () {},
                  ),
                ),
              ],
                ...
                children: [
                  ...
                  AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      ...
                      shape: BoxShape.circle,
                      boxShadow: _isFullScreen ? [] : [BoxShadow(color: Colors.black.withOpacity(0.05), blurRadius: 4)],
                    ),
                    child: IconButton(
                  ...
                  AnimatedContainer(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Icon(Icons.arrow_drop_down, color: AppTheme.darkText.withOpacity(0.7)),
                      ],
                    ),
                  ),
