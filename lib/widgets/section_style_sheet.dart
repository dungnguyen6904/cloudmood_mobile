...
class _SectionStyleSheetState extends State<SectionStyleSheet> {
  ...
  List<Map<String, dynamic>> _flattenedItems = [];
  ...
  final List<IconData> _icons = [
    Icons.looks_one_rounded, Icons.push_pin, Icons.directions_car, Icons.local_cafe, Icons.train, Icons.directions_bus, Icons.directions_boat, Icons.location_on, Icons.camera_alt,
    Icons.coffee, Icons.shopping_bag, Icons.restaurant, Icons.wine_bar, Icons.landscape, Icons.sailing, Icons.check,
  ];
  ...
  void _buildFlattenedItems() {
    ...
    for (var section in _sections) {
      ...
      final places = _savedPlaces.where((p) => p['section'] == section).toList();
      for (var p in places) {
                ...
                Expanded(
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Text('Các phần', style: TextStyle(
               ...
               child: SingleChildScrollView(
                 ...
                 child: Column(
                   ...
                   children: [
                         ...
                         return GestureDetector(
                           ...
                           onTap: () {
                             setState(() {
                               ...
                               _selectedColor = _sectionColors[section] ?? Colors.indigoAccent;
                               _selectedIcon = _sectionIcons[section] ?? Icons.looks_one_rounded;
                             });
                           },
                           child: Container(
                             ...
                             child: Row(
                               children: [
                                 CircleAvatar(
                                   backgroundColor: isSelected ? _selectedColor : (_sectionColors[section] ?? Colors.grey[300]),
                                   child: Icon(isSelected ? _selectedIcon : (_sectionIcons[section] ?? Icons.looks_one_rounded), color: Colors.white),
                                 ),
                     ...
                     const Text('Biểu tượng', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
                     const SizedBox(height: 12),
                     Wrap(
                       spacing: 12,
                       runSpacing: 12,
                       children: _icons.map((i) => GestureDetector(
                         ...
                         child: CircleAvatar(
                           radius: 18,
                           backgroundColor: _selectedIcon == i ? _selectedColor : Colors.grey[200],
                           child: Icon(i, color: _selectedIcon == i ? Colors.white : AppTheme.darkText, size: 20),
                         ),
                       )).toList(),
                     ),
                     const SizedBox(height: 12),
                     ...
                     return Container(
                      ...
                      if (place['Place'] != null && place['Place']['name'] != null) {
                        ...
                        if (text.startsWith('[TODO] ')) {
                          ...
                          placeName = title.isEmpty ? 'Danh sách công việc' : title;
                        } else {
